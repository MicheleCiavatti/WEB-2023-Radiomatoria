                                        ...
                                        <li>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <?php if (isset($_SESSION['NomeUtente']) && isLiked($_SESSION['NomeUtente'], $comment['Creatore'], $comment['NrPost'], $comment['NrCommento'])): echo 'class="preferred_button"'; else: echo 'class="preference_button"'; endif;?>>Like</button></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <?php if (isset($_SESSION['NomeUtente']) && isDisliked($_SESSION['NomeUtente'], $comment['Creatore'], $comment['NrPost'], $comment['NrCommento'])): echo 'class="preferred_button"'; else: echo 'class="preference_button"'; endif;?>>Dislike</button></td>
                                                </tr>
                                            </table>
                                            <footer>
                                                <?php if(isset($_SESSION['NomeUtente'])): ?>
