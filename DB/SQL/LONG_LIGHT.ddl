...
create table UTENTI (
     ...
     IndirizzoMail varchar(100) not null unique,
...
create table INTERAZIONI (
     Creatore varchar(50) not null,
     ElementCreator varchar(50) not null,
     ElementIdPost int not null,
     ElementIdCommento int,
     Tipo char not null,
     constraint IDINTERAZIONI primary key (Creatore, ElementCreator, ElementIdPost, ElementIdCommento));
...
alter table INTERAZIONI add constraint FKINT_POS
     foreign key (ElementCreator, ElementIdPost)
     references POST (Creatore, NrPost)
     on delete CASCADE;

alter table INTERAZIONI add constraint FKINT_COM
     foreign key (ElementCreator, ElementIdPost, ElementIdCommento)
     references COMMENTI (Creatore, NrPost, NrCommento)
     on delete CASCADE;
