            ...
            <article>
                <ul>
                    ...
                    <li>
                        <table>
                            <tr>
                                <td><button onclick="accessProfile(<?php echo $post['UserPost']; ?>)"></button><?php echo $post["UserPost"]; ?></td>
                            ...
                            <tr>
                                ...
                                <td><button name="<?php echo $post['NrPost']; ?>_like_button" class="preference_button" onclick="<?php if(cookiesSet()): ?>like($post['NrPost'])<?php endif; ?>">Like</button></td>
                                <td><?php echo $post["DislikePost"]; ?></td>
                                <td><button name="<?php echo $post['NrPost']; ?>_dislike_button" class="preference_button" onclick="<?php if(cookiesSet()): ?>dislike($post['NrPost'])<?php endif; ?>">Dislike</button></td>
                                <?php if(cookiesSet()): ?>
                                ...
                                <li>
                                    <table>
                                        <tr>
                                            ...
                                            <?php if($commento['UserCommento'] == readCookie('NomeUtente')): ?>
